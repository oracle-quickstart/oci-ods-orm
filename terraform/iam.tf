...
locals {
  ...
  ods_policies = [
    ...
    "Allow group ${oci_identity_group.ods-group.name} to use log-groups ${data.oci_identity_compartment.current_compartment.id == var.tenancy_ocid ? "in tenancy" : "in compartment ${data.oci_identity_compartment.current_compartment.name}"}",
    "Allow group ${oci_identity_group.ods-group.name} to use log-content ${data.oci_identity_compartment.current_compartment.id == var.tenancy_ocid ? "in tenancy" : "in compartment ${data.oci_identity_compartment.current_compartment.name}"}",
    # 
    ...
    "Allow dynamic-group ${oci_identity_dynamic_group.ods-dynamic-group.name} to use log-content ${data.oci_identity_compartment.current_compartment.id == var.tenancy_ocid ? "in tenancy" : "in compartment ${data.oci_identity_compartment.current_compartment.name}"}",    
